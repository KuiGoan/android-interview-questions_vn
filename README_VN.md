...
> Mức độ caai hỏi và chủ đề của Cấu trúc dữ liệu và Giải thuật hoàn toàn phụ thuộc vào công ty mà bạn tham gia.
...
* Mảng
    ...
    - Một mảng bao gồm một nhóm các phần tử có cùng kiểu dữ liệu. Nó được lưu trữ liên tục trong bộ nhớ và bằng cách sử dụng index của nó, bạn có thể tìm thấy dữ liệu cơ bản. Mảng có thể là một chiều và đa chiều. Mảng một chiều là cấu trúc dữ liệu đơn giản nhất và cũng được sử dụng phổ biến nhất. Điều đáng chú ý là trong các mảng đa chiều của ngôn ngữ Java được triển khai dưới dạng các mảng của mảng. Ví dụ, `int [10][5]` thực sự là một mảng với các ô của nó trỏ đến mười mảng 5 phần tử.
...
* LinkedList
    ...
    - LinkedList, giống như một cái cây và không giống như một mảng, bao gồm một nhóm các nút cùng 
    thể hiện một chuỗi. Mỗi nút chứa dữ liệu và một con trỏ. Dữ liệu trong một nút có thể là bất cứ thứ gì, 
    nhưng con trỏ là tham chiếu đến mục tiếp theo trong LinkedList. LinkedList chứa cả đầu và đuôi.
    "Đầu" là item đầu tiên trong LinkedList, trong khi "Đuôi" là item cuối cùng. Nó không phải 
    là cấu trúc dữ liệu tròn, do đó đuôi không có con trỏ trỏ vào Đầu - con trỏ chỉ là `null`. 
    Độ phức tạp thời gian chạy cho từng phương thức cơ bản như sau:
